<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div>
            {{ __('Se necessário, você deverpa se deslogar de todas as outras sessões, pois pode ser que ainda há uma sessão aberta. Se acha que sua conta foi invadida, você deve mudar a senha.') }}
        </div>
                            ...
                            <div>
                                <div class="small font-weight-lighter text-muted">
                                    ...
                                    @if ($session->is_current_device)
                                        <span class="text-success font-weight-bold">{{ __('Esse dispositivo') }}</span>
                                    @else
        ...
        <div class="d-flex mt-3">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Desconectar as sessões de outros navegadores') }}
            </x-jet-button>
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor digite sua senha para confirmar que você quer desconectar todas suas sessões.') }}
